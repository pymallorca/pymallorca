...
def get(value, default):
    return opts.get(value, default, section='Filer')
...
class FilerMixin(object):
    ...
    def default_file_storage(self):
        ...
        return getattr(Settings, 'DEFAULT_FILE_STORAGE',
    ...
    def FILER_CUSTOM_SECURE_MEDIA_ROOT(self):
        ...
        return opts.get('FILER_CUSTOM_SECURE_MEDIA_ROOT',
                abspath(join(self.MEDIA_ROOT, '..', 'smedia')))

    @property
    def filer_private_files_path(self):
        return abspath(join(self.FILER_CUSTOM_SECURE_MEDIA_ROOT,
            'filer_private'))
